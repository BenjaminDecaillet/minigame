...
A simple web-based minigame project. This project is built using HTML, CSS, and JavaScript.

## How to Play

To play the game open the `index.html` file in your web browser. Enjoy!
